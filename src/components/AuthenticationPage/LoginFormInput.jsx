...
const LoginFormInput = ({ type, propKey, propName, iconName }) => {
    ...
    return (
        <FormGroup className="mb-3 position-relative" style={{ color: '#56AB91' }}>
            ...
            <Form.Control type={type} className="bg-transparent ps-0 border-0 border-bottom rounded-0 d-inline" name={propKey} placeholder={`Enter your ${propName.toLowerCase()}`} value={data[propKey]} onChange={handleChange} />
